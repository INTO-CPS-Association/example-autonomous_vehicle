...
#define xx_constants_count 1
#define xx_parameter_count 36
#define xx_initialvalue_count 9
#define xx_variable_count 97
#define xx_state_count 9

#define xx_NUMBER_MATRICES 4
#define xx_NUMBER_UNNAMED 4
...
/* Global pointer to co-simulator callback functions */
	...
	XXDouble U[xx_NUMBER_UNNAMED];		/* unnamed */
